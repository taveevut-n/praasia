  ...
  <tr>
    <td bgcolor="#311407"><table width="100%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="top" bgcolor="#3f1d0e"><table width="95%" border="0" align="center" cellpadding="3" cellspacing="1">
          <tr class="bh">
		    ...
		    <td width="70" align="center" bgcolor="#692908">ผู้เยี่ยมชม</td>
		    <td width="79" align="center" bgcolor="#692908">สินค้าแนะนำ</td>            
		    <td width="52" align="center" bgcolor="#692908">แก้ไข</td>
  ...
  static $v=1; 
   ...
   ?>		
		  <tr bgcolor="<?=($v%2==1)?"#311407":"#4f3b2a"?>" class="sidemenu">
		    ...
		    <td align="center"><? if($db->f(hot)=='0'){?>
                            <a href="" ><img src="../images/wait.png" alt="No Hot" width="24" height="24" border="0"></a>
                                <? }else{?>
								<a href="" >
                              <img src="../images/ok.png" alt="Hot" width="24" height="24" border="0"></a>
            <? }?></td>
		    <td align="center"><a href="backend_add.php?e_product_id=<?=$db->f(product_id)?>" ><img src="images/edit.gif" width="19" height="23" border="0"></a></td>
		    <td align="center"><a href=""  onClick="return confirm('Confirm Delete Data')"><img src="images/del.gif" width="19" height="23" border="0"></a></td>
	      </tr><?php $v++; } ?>
		  <tr>
