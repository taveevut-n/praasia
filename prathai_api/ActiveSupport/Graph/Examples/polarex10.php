...
$data = array (5, 1, 20, 5, 30, 25, 40, 60, 50, 110, 60, 160, 70, 210, 75, 230, 80, 260, 85, 370, 90, 480, 95, 370, 100, 260, 105, 230, 110, 210, 120, 160, 130, 110, 140, 60, 150, 25, 160, 5, 175, 1 );
$n = count ( $data );
/*
for($i=0; $i < $n; $i+=2 ) {
    $data[$n+$i] = 360-$data[$i];
