...
class BarPlot extends Plot {
	...
	function Legend(&$graph) {
		if ($this->grad && $this->legend != "" && ! $this->fill) {
			...
			$graph->legend->Add ( $this->legend, $color, "", - $this->grad_style, $this->legendcsimtarget, $this->legendcsimalt );
			...
			$graph->legend->Add ( $this->legend, $color, "", - 101, $this->legendcsimtarget, $this->legendcsimalt );
