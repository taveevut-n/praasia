            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="background:url(images/bg-blog.png) repeat-y; padding-left:5px"><table width="186" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr>
                    <td height="20"><a href="admin_theme.php"><span style="color:#1A4A74">- ตั้งค่ารูปแบบธีมเว็บไซต์</span></a></td>
                  </tr>
                  <tr>
...
<tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="background:url(images/bg-blog.png) repeat-y; padding-left:5px"><table width="186" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr>
                    <td height="20" bgcolor="#ACDAF1"><a href="admin_system.php"><span style="color:#1A4A74">- กำหนดสิทธิ์ผู้ใช้</span></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="background:url(images/hd-blog.png) no-repeat; padding-left:8px; color:#F5821F; font-weight:bold" height="32"><img src="images/Games1.png" width="20" height="20" />ระบบพื้นฐาน</td>
              </tr>
              <tr>
                <td style="background:url(images/bg-blog.png) repeat-y; padding-left:5px"><table width="186" border="0" cellspacing="0" cellpadding="3">
                  <tr>
                  ...
                  <tr>
                    <td height="20" ><a href="admin_download2.php"><span style="color:#1A4A74">- ระบบดาวน์โหลด</span></a></td>
                  </tr> 
                  <tr>
