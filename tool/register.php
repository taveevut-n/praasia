...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td height="643" valign="top" style="background:#1b0800"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
<td style="padding:3px; padding-top:5px">
		<script language="JavaScript" type="text/javascript">
			...
			function confirm_email(x_this){
				...
				<form action="sent_regit.php" method="post" name="REG" id="REG" onsubmit="return reg_fo()" enctype="multipart/form-data">
				<table width="95%" border="0" align="center" cellpadding="5" cellspacing="1">
					...
					<tr>
						<td width="28%" align="right" bgcolor="#311308" class="detail-text" id="detail-text"> Select Package / เลือกแพคเกจร้านค้า</td>
						<td width="77%" bgcolor="#311308"><table border="1" cellpadding="3" cellspacing="0" width="100%" bordercolor="#999999" style="border-collapse:collapse" >
						  <tbody>
						    <tr bgcolor="#999999">
						      <td height="30" bgcolor="#DDDDDD"><div align="center"><strong>ขนาดร้านค้า / องค์</strong><br />
					          商店产品数 / 尊						      </div></td>
						      <td bgcolor="#DDDDDD"><div align="center"><strong>อัตรา / 6 เดือน (บาท)</strong><br />
					          六个月 / 品格(THB)						      </div></td>
						      <td bgcolor="#DDDDDD"><div align="center"><strong>อัตรา / ปี (บาท)</strong><br />
					          一年 / 品格(THB)						      </div></td>
					        </tr>
						    <tr bgcolor="#CCCCFF">
						      <td bgcolor="#EFEFEF"><div align="right">Package A / 15</div></td>
						      <td bgcolor="#EFEFEF"><div align="right">500
						    ...
						    <tr bgcolor="#CCCCCC">
						      <td bgcolor="#F8F8F8"><div align="right">Package B / 25</div></td>
						      <td bgcolor="#F8F8F8"><div align="right">
				            750
						    ...
						    <tr bgcolor="#CCCCFF">
						      <td bgcolor="#EFEFEF"><div align="right">Package C / 50</div></td>
						      <td bgcolor="#EFEFEF"><div align="right">
				            1,000
						    ...
						    <tr bgcolor="#CCCCCC">
						      <td bgcolor="#F8F8F8"><div align="right">Package D / 100</div></td>
						      <td bgcolor="#F8F8F8"><div align="right">
				            1,250
						    ...
						    <tr bgcolor="#CCCCFF">
						      <td bgcolor="#EFEFEF"><div align="right">Package E/ 200</div></td>
						      <td bgcolor="#EFEFEF"><div align="right">1,500
						        <input name="package" type="radio" value="E182"  />
						      </div></td>
						      <td bgcolor="#EFEFEF"><div align="right">2,500
						        <input name="package" type="radio" value="E365"  />
						      </div></td>
					        </tr>
						    <tr bgcolor="#CCCCCC">
						      <td bgcolor="#F8F8F8"><div align="right">Package F / 300</div></td>
						      <td bgcolor="#F8F8F8"><div align="right">1,750
						        <input name="package" type="radio" value="F182"  />
						      </div></td>
						      <td bgcolor="#F8F8F8"><div align="right">3,000
						        <input name="package" type="radio" value="F365"  />
						      </div></td>
					        </tr>
						    <tr bgcolor="#CCCCFF">
						      <td bgcolor="#EFEFEF"><div align="right">Package G / 400</div></td>
						      <td bgcolor="#EFEFEF"><div align="right">2,000
						        <input name="package" type="radio" value="G182"  />
						      </div></td>
						      <td bgcolor="#EFEFEF"><div align="right">3,500
						        <input name="package" type="radio" value="G365"  />
						      </div></td>
					        </tr>
						    <tr bgcolor="#CCCCCC">
						      <td bgcolor="#F8F8F8"><div align="right">Package H / 500</div></td>
						      <td bgcolor="#F8F8F8"><div align="right">2,500
						        <input name="package" type="radio" value="H182"  />
						      </div></td>
						      <td bgcolor="#F8F8F8"><div align="right">4,000
						        <input name="package" type="radio" value="H365"  />
						      </div></td>
					        </tr>
						    <tr bgcolor="#CCCCFF">
						      <td bgcolor="#EFEFEF"><div align="right">Package I / 600</div></td>
						      <td bgcolor="#EFEFEF"><div align="right">3,000
						        <input name="package" type="radio" value="I182"  />
						      </div></td>
						      <td bgcolor="#EFEFEF"><div align="right">4,500
						        <input name="package" type="radio" value="I365"  />
						      </div></td>
					        </tr>
						    <tr bgcolor="#CCCCCC">
						      <td bgcolor="#F8F8F8"><div align="right">Package J / 700</div></td>
						      <td bgcolor="#F8F8F8"><div align="right">3,500
						        <input name="package" type="radio" value="J182"  />
						      </div></td>
						      <td bgcolor="#F8F8F8"><div align="right">5,000
					...
					<tr>
						...
						<td width="77%" bgcolor="#311308"><input name="amuletuser" type="text" id="amuletuser" autocomplete="off" /></td>
					</tr>
					<tr>
						<td align="right" bgcolor="#311308" class="detail-text" id="detail-text">密码 / รหัสผ่าน (password) :</td>
						<td bgcolor="#311308"><input name="amuletpass" type="password" id="amuletpass" autocomplete="off"  /></td>
					</tr>
			<tr>
						<td align="right" bgcolor="#311308" class="detail-text" id="detail-text">确定密码 / ยืนยันรหัสผ่าน (confirm password) :</td>
						<td bgcolor="#311308"><input onkeyup="confirm_password($(this))" name="amuletpass_confirm" type="password" id="amuletpass_confirm" autocomplete="off"  /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td bgcolor="#311308"><input name="name" type="text" id="name" /></td>
					</tr>              
					<tr>
						<td align="right" bgcolor="#311308" class="detail-text" id="detail-text">電子郵件 / อีเมลล์  :</td>
						<td bgcolor="#311308"><input name="email" type="text" id="email" /></td>
					</tr>
					<tr>
					  <td align="right" bgcolor="#311308" class="detail-text" id="detail-text5">再确定電子郵件 / ยืนยันอีเมลล์  :</td>
					  <td bgcolor="#311308"><input name="email2" type="text" id="email2" onkeyup="confirm_email($(this))"/></td>
				  </tr>
					<tr>
						<td align="right" bgcolor="#311308" class="detail-text" id="detail-text">電話 / โทรศัพท์บ้าน :</td>
						<td bgcolor="#311308"><input name="tel" type="text" id="tel" />
						&nbsp; <span class="detail-text"><span style="color:red">** 如有家电话 / ถ้ามี</span></span></td>
					</tr>
					<tr>
						<td align="right" bgcolor="#311308" class="detail-text" id="detail-text">手提 / โทรศัพท์มือถือ :</td>
						<td bgcolor="#311308"><input name="mobile" type="text" id="mobile" />
						&nbsp; <span style="color:red">** 必需填写 / จำเป็นต้องมี</span></td>
					</tr>
					<tr>
					  	<td align="right" bgcolor="#311308" class="detail-text" id="detail-text2">地址 / ที่อยู่ :</td>
					  	<td bgcolor="#311308"><textarea id="address" name="address" style="margin:0px; padding:0px; height:100px;"></textarea><br/> <span style="color:red">*** 地址必需填写完整 / กรุณากรอกที่อยู่ให้ครบถ้วนตั้งแต่บ้านเลขที่-จังหวัด</span>
			            <script>
					...
					<tr>
						...
						<td bgcolor="#311308">
							<select name="country" id="country">
								...
								</select> <span class="detail-text"><span style="color:red">** 必需填写 / จำเป็นต้องมี</span></span>
						</td>
					</tr>
					<tr>
					 ...
					 &nbsp; <span style="color:red">** 必需填写 / จำเป็นต้องมี</span></span></td>
				  </tr>
					<tr>
					...
					<tr>
						...
						<span style="color:#FC0">*</span> <input name="Check" type="button" id="Check" value="ตรวจสอบ / 查看" OnClick="JavaScript:SubmitContent();"></td>
					</tr>
					<tr>
                    ...
                    <table width="550" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse;border-spacing: 0">
			          ...
			          <tr>
			            ...
			            <td colspan="2" rowspan="2"><span class="detail-text">
			              ...
			              </span><span class="detail-text"> %</span></td>
		              </tr>
			          <tr>
			      ...
			      <tr>
			        ...
			        <td align="left" valign="top" bgcolor="#311308" style="height:25px;"><table width="593" border="0" align="left" cellpadding="3" cellspacing="0">
			      ...
			      <tr>
			        ...
			        </span><span style="color:#FC0">必需与身份证的名字相同 </span><span style="color:#FF0000;font-weight:bold;font-size:10px;">/ ให้ตรงกับสำเนาบัตรประชาชน</span></td>
		          </tr>
			      <tr>
...
/ สำเนาบัตรประชาชน :</td>
			        ...
			        </span><span style="color:#FF0000;font-weight:bold;font-size:10px;">*</span></td>
		          </tr>
			      <tr>
			        ...
			        <td align="left" valign="top" bgcolor="#311308" style="height:25px;"><input name="paypal" type="text" id="paypal" style="width:200px" />
			          &nbsp; <span style="color:red">** 如有注册 / ถ้ามี</span></td>
		          </tr>
			      <tr>
...
<img id="inum2" title="<?=$_SESSION['ses_inum2']=rand(0,9)?>" src="images/digit/<?=$_SESSION['ses_inum2']?>.gif" />               
 <img src="images/digit/equal.gif" />
	<input name="inum3" type="text" id="inum3"  title="board_require" style="margin:0px;padding:0px;height:25px;border:1px #CCCCCC outset;background-color:#F5F5F5;color:#FF9900;font-size:20px;font-weight:bold;text-align:center;width:30px;" size="3" maxlength="2" />
	 <span style="color:#FC0">* 必需要填 </span><span style="color:#FF0000;font-weight:bold;font-size:10px;"> / จำเป็นต้องกรอก</span>    </td>
		</tr>    
		<tr>
		...
		<tr>
				<td colspan="2" align="center">
				 <span style="color:#F00">กรอกรายละเอียดเรียบร้อยแล้ว ยืนยันการใช้งานที่อีเมลล์ของท่านอีกครั้งหนึ่ง</span>
				 <br />
				 <span style="color:#FC0">/填表完整以后，请还要在你的 E-Mail里面确定本人 E-MAIL一下，商店才能开</span></td>
			</tr>
								<tr>
				<td colspan="2" align="center">
				 <span style="color:#F00">หากสมัครด้วย hotmail.com hotmail.co.th outlook.com โปรดตรวจสอบอีเมลล์ยืนยันตัวตนในจดหมายขยะ [Junk mail]ด้วย</span>
				 <br />
				 <u></u><span style="color:#FC0">如果用 hotmail.com hotmail.co.th outlook.com 来注册，必需在确定本人的E-mail里查看，是否在垃圾桶里</span></td>
			</tr>
				</table>
				</form>
			  </td>
