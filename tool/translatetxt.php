...
<?php 
	if($_POST['Submit']){
				$q="UPDATE `translate_txt` SET 
				`detail` = '".$_POST['detail']."' WHERE `id` ='1' ";
				$db->query($q);
		redi2();							
		}			
?>
                  ...
                  <?php
		$q="SELECT * FROM translate_txt WHERE id='1' ";
		$db5=new nDB();
		$db5->query($q);
		$db5->next_record();
?>
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2" class="box_from3_2">
                            <tr>
                              <td height="25" colspan="2" align="center" bgcolor="#4d1403" class="bh">ตัวอย่างการแปลภาษา</td>
                      </tr>                        
			    <tr>
                              <td align="right" bgcolor="#3c1204" class="sidemenu"  style="padding-right:3px">Detail</td>
                              <td bgcolor="#3c1204"><textarea id="detail" name="detail"><?=$db5->f(detail)?></textarea>
							<script>
