...
<?php 
	if($_POST['Submit']){
		if($_POST['h_data_id']==''){
				...
				$q="INSERT INTO `findamulet` ( `amulet_id` , `name` , `detail` , `pic`) 	
				VALUES (	'', '".$_POST['name']."' , '".$_POST['detail']."' , '".$file_up2."');";
				$db->query($q);
		al('Add Complete');
		redi4('venderamulet_category.php');
		}else{
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2" class="box_from3_2">                            
                            <tr>
                              <td height="25" colspan="2" align="center" bgcolor="#4d1403" class="bh">รายการพระเครื่องที่ต้องการหา</td>
                      </tr>
							 <tr>
