...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2" class="box_from3_2">
                            <tr>
							 ...
							 <tr>
                              <td width="19%" align="right" bgcolor="#3c1204" class="sidemenu"  style="padding-right:3px">Username :</td>
                              <td width="81%" bgcolor="#3c1204"><input name="certdoc_username" type="text" class="box_from3" id="certdoc_username" value="<?=($_GET['e_data_id'])?$db5->f(certdoc_username):""?>" size="45" /></td>
                              </tr>
							 <tr>
                              <td width="19%" align="right" bgcolor="#3c1204" class="sidemenu"  style="padding-right:3px">หมายเลข EMS เข้า :</td>
                              <td width="81%" bgcolor="#3c1204" class="sidemenu">
                              <input name="certdoc_ems1" type="text" class="box_from3" id="certdoc_ems1" value="<?=($_GET['e_data_id'])?$db5->f(certdoc_ems1):""?>" size="45" /> 
                              วันที่ : 
                                                                <input type="text" class="datepicker" name="certdoc_dateems1"  id="datepicker" value="<?=($_GET['e_data_id'])?date("d-m-Y",strtotime($db5->f(certdoc_dateems1))):""?>"/>
							 ...
							 <tr>
                              <td width="19%" align="right" bgcolor="#3c1204" class="sidemenu"  style="padding-right:3px">หมายเลข EMS ออก :</td>
                              <td width="81%" bgcolor="#3c1204" class="sidemenu"><input name="certdoc_ems" type="text" class="box_from3" id="certdoc_ems" value="<?=($_GET['e_data_id'])?$db5->f(certdoc_ems):""?>" size="45" />
                              วันที่ : <input type="text" class="datepicker2" name="certdoc_dateems"  id="datepicker2" value="<?=($_GET['e_data_id'])?date("d-m-Y",strtotime($db5->f(certdoc_dateems))):""?>"/>
                                <script>
							 ...
							 <tr>
                              <td width="19%" align="right" bgcolor="#3c1204" class="sidemenu"  style="padding-right:3px">ประเภทสมาชิก :</td>
                              <td width="81%" bgcolor="#3c1204">
                              <select name="certdoc_type">
                      ...
                      <tr>
                        <td align="right" valign="top" bgcolor="#3c1204" class="sidemenu" >รูปภาพรับสินค้า 1</td>
                        <td align="left" valign="top" bgcolor="#3c1204" class="sidemenu" ><input name="file1" type="file" id="file1"  /></td>
                      </tr>       
                      <tr>
                        <td align="right" valign="top" bgcolor="#3c1204" class="sidemenu" >รูปภาพรับสินค้า 2</td>
                        <td align="left" valign="top" bgcolor="#3c1204" class="sidemenu" ><input name="file2" type="file" id="file2"  /></td>
                      </tr>  
                      <tr>
                        <td align="right" valign="top" bgcolor="#3c1204" class="sidemenu" >รูปภาพรับสินค้า 3</td>
                        <td align="left" valign="top" bgcolor="#3c1204" class="sidemenu" >	<input name="file3" type="file" id="file3"  /></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top" bgcolor="#3c1204" class="sidemenu" >รูปภาพรับสินค้า 4</td>
                        <td align="left" valign="top" bgcolor="#3c1204" class="sidemenu" >	<input name="file4" type="file" id="file4"  /></td>
                      </tr>                                                                
                            <tr>
				   ...
				   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3" bordercolor="#FFFFFF" style="font-size:12px">
                          <tr>
                            ...
                            <form method="post" action="search_certificate_systems2.php">
                                <table width="100%">
                                    <tr>
                                        <td align="right">
                                            <input type="text" name="search" placeholder="ค้นหารายการพระจาก ID และ ชื่อพระ" style="width:300px" /><input type="submit" name="submit_search" />
                                        </td>
                                     </tr>
                                </table>
                            </form>
