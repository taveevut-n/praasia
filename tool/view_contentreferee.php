    ...
    <td bgcolor="#311407">
			    <table width="100%" border="0" cellspacing="0" cellpadding="3">
                  ...
                  <tr>
                    <td>
                    <? 
						  	$q="SELECT * FROM `content_certificate` WHERE content_id = '".$_GET["id"]."' ORDER BY content_id DESC";
							$db->query($q);
							static $v=1;
                            ...
                            <td><table width="95%" border="0" align="center" cellpadding="3" cellspacing="0">
                              ...
                              <tr>
                                <td>
                                	...
                                	<?php
                                                  $c_pic = 0;
                                                  $q_pic = mysql_query("SELECT * FROM collection WHERE content_id = '".$_GET["id"]."' ORDER BY collection_order ASC ");
                                                  $n_pic = mysql_num_rows($q_pic);
                                                    if($n_pic > 0){
                                                      while ($pic = mysql_fetch_array($q_pic)) {
                                                        $c_pic = $c_pic + 1;
                                                    ?>
                                                        <a href="view_pic_content.php?pic=<?=$pic['collection_img']?>&f=referee_collect" class = "iframe" >
												 ...
												 <?php
						                           ...
						                           ?>
													...
													<?php
				                                      if ($filename_arr[$i] != "") {
				                                    ?>
				                                       <a href="view_pic_content.php?pic=<?=$filename_arr[$i]?>&name=<?=$file_arr[$i]?>&f=content_certificate" class = "iframe" > <img height="75px"  width="65px" style="margin-right:5px;margin-top:5px;" src="../img/content_certificate/<?=$filename_arr[$i]?>"></a>
				                                    <?php
				                                      }
				                                    ?>
						                         <?php
