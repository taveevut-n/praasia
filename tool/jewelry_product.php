                      ...
                      <tr>
                        <td>
                          ...
                          <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                            ...
                            <table width="95%" border="0" align="center" cellpadding="3" cellspacing="0" style="border:1px #8C3F17 solid">
                                ...
                                <td align="left" valign="top" bgcolor="#3c1204">
                                  <span class="sidemenu">
                                    <select name="catalog" id="catalog">
                                      ...
                                      ?>
                                      >ขายส่งเพชรสวิส พลอยสีต่าง ๆ / 水晶钻石 宝石等</option>
                                      <option value="2"
                                      <?php
                                      if ($_GET['e_product_id']) {
                                        if ($db5->f(catalog) == '2') {
                                      ...
                                      ?>
                                      >กัานปู แหนบ จี้ กำไล - สร้อย / 活扣-夹子-垂饰-手镯-项链</option>
                                      <option value="5"
                                      <?php
                                      if ($_GET['e_product_id']) {
                                        if ($db5->f(catalog) == '5') {
                                      ...
                                      ?>
                                      >กรอบเงิน เครื่องเงิน / 银壳 银首饰</option>
                                      <option value="3"
                                      <?php
                                      if ($_GET['e_product_id']) {
                                        if ($db5->f(catalog) == '3') {
                                      ...
                                      ?>
                                      >กรอบ-ตลับทอง - งานทอง / 金壳开关壳 金首饰</option>
                                      <option value="6"
                                      <?php
                                      if ($_GET['e_product_id']) {
                                        if ($db5->f(catalog) == '6') {
                              ...
                              <tr>
                                ...
                                <td align="left" valign="top" bgcolor="#3c1204">
                                  <span class="sidemenu">
                                    <input name="status" type="checkbox" id="status" value="1" <?php
                                                                                                if ($_GET['e_product_id']) {
                                                                                                  if ($db5->f(status) == 1) {
                          ...
                          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <?php } ?>
                            <tr>
                              <td height="30" colspan="6" align="center"> <?php sh_page($total, $s_page, $e_page, $chk_page, Previous, Next, "#333333", "#F8F8F8"); // นำไปวางในตำแหน่งที่ต้องการแสดง 
                                                                          ?></td>
                            </tr>
                          </table>
                          <p>&nbsp;</p>
