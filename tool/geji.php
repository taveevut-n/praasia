...
<?php 
	if($_POST['Submit']){
		if($_POST['h_geji_id']==''){
				...
				$q="INSERT INTO `geji` ( `geji_id` , `topic` , `detail` , `mem_id` , `pic1`) 	VALUES (	'', '".$_POST['topic']."' , '".$_POST['detail']."' , '0' , '".$file_up2."');";
				$db->query($q);
		al('Add Complete');
		redi2();
		}else{
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
				   ...
				   <table width="700" border="0" align="center" cellpadding="0" cellspacing="3" bordercolor="#FFFFFF">
                          <tr class="bh">
                            <td width="22%" height="25" align="center" bgcolor="#4d1403" class="style11" >ประวัติเกจิ</td>
						  ...
						  <?php 
						  	$q="SELECT * FROM `geji` WHERE 1 ORDER BY geji_id DESC";
							$db->query($q);
							static $v=1;
                          ...
                          <tr bgcolor="<?=($v%2==0)?"#3c1204":"#3c1204"?>">
                            <td height="110" align="left" style="padding-left:10px" bgcolor="#3c1204"><img src="../slir/w100-h100/img/geji/<?=$db->f(pic1)?>" width="100" height="100" /></td>
                            <td align="center"   style="color:#FC0" bgcolor="#3c1204"><?=$db->f(topic)?></td>
                            <td align="center"  bgcolor="#3c1204"><a href="../shop_index.php?shop=<?=$dbmember->f(id)?>" style="color:#FC0" target="_blank"><?=$by?></a></td>
