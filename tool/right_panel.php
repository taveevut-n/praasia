						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td style="padding-left:10px; width:1px; vertical-align:top;">
									<textarea class="textbox_translate" onkeyup="translate_text($(this));" style="padding:10px; width:250px; height:150px;"></textarea>
								</td>
				...
				<tr>
					<td style="padding-top:7px; padding-bottom:7px; background-color:#ffffff;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td class="translateleave_info" colspan="2" style="padding-left:20px; padding-right:10px; padding-top:3px; font-size:12px;">
									กรุณากรอกข้อความที่ต้องการฝากแปล
								/请输入佛牌交易方面的常用语给系统帮忙翻译</td>
							</tr>
						</table>
					</td>
				</tr>
