	...
	<div id="wrapper">
		...
		<div id="container">
			...
			<div class="box_content">
				...
				<table width="1000px" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
					<tr>
						<td colspan="2" align="center" class="each-head">
							พระเครื่องที่ตั้งประมูล โดยคุณ <?php echo $_GET['each_name'];?>
						</td>
					</tr>
				</table>
				<p>&nbsp;</p>
				<table width="1000px" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
					<tr>
						<td colspan="2" bgcolor="#4A1701" class="head_contain" style="padding-left: 11px;text-align:left;">
							<span class="text_yellpw"><b><?=$language['link_list_dataauction'];?></b></span>
						</td>
					</tr>
					<tr>
						<td colspan="2" align="center" style="height:100%;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table condition_tb_textjustify">
								...
								if($_GET['each_id']){
									$each_id = "AND ar.reg_memid = '".$_GET['each_id']."' ";
								}

								$sql_auction = "SELECT * FROM auc_regist ar LEFT JOIN auc_member am ON ar.reg_memid  = am.m_id WHERE 1 $each_id GROUP BY ar.reg_id ORDER BY ar.rec_sort ASC , ar.rec_order DESC";
								...
								<tr <?=$change_color;?> >
									...
									<td align="center" width="1">
										<?php
											...
											if($nreply != 0)
											{
												echo $resultreplynow['m_username'];
												?>
