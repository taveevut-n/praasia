...
<table style="width:717px; height:350px; " border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td style="vertical-align:top; font-size:14px; color:#444444;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr style="height:30px;">
								<td style="padding-left:10px;">
									<table width="100%" border="0" cellpadding="0" align="center" cellspacing="0">
										<tr>
											<td align="left">ใส่คำที่ต้องการแปล/输入单词进行翻译 </td>
											<td align="right"><a href="javascript:void(0);" onclick="rightpanel_translate_text($('#textbox_translate'));">แปล / 翻译&nbsp;<img width="20" src="../images/translate_bo_icon.png" border="0"></a></td>
										</tr>
									</table>
								</td>
								<td style="padding-left:10px;">
							...
							<tr>
								<td style="padding-left:10px; width:1px; vertical-align:top;">
									<textarea id="textbox_translate" class="textbox_translate"  onKeyUp="rightpanel_translate_text($(this));" style="padding:10px; width:350px; height:150px;"></textarea>
								</td>
				...
				<tr>
					<td style="padding:10px; padding-top:7px; padding-bottom:7px; font-size:14px; font-weight:bold; background-color:#f5f5f5; border-top:1px solid #e1e1e1; border-bottom:1px solid #e1e1e1;">
						ฝากแปลภาษาที่เกี่ยวกับวงการพระเครื่อง / 输入关于佛牌交易方面的用词进行帮我翻译和存录
					</td>
				</tr>
				<tr>
