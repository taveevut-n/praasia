						...
						<td colspan="2" bgcolor="#4A1701" class="head_contain" style="padding-left: 11px;text-align:left;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td align="right"><input type="hidden" value="<?=$_GET['id_cat']?>"><input type="text" name="q" placeholder="ค้นหารายการประมูลในห้องนี้" style="width:200px"><input type="submit" name="search" value="ค้นหา"></td>
                              </tr>
                            </table>
                            </form>
						</td>
					...
					<tr>
						<td colspan="2" align="center" style="height:100%;">
							<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table condition_tb_textjustify">
								...
								$sql_auction = "SELECT * FROM auc_regist ar LEFT JOIN auc_member am ON ar.reg_memid  = am.m_id WHERE ar.reg_wattuname Like '%".$_POST['q']."%' AND ar.reg_catalogid = '".$_POST['id_cat']."' GROUP BY ar.reg_id  ORDER BY ar.rec_sort ASC , ar.rec_order DESC";
