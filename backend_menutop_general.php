...
<table class="menutop_table" style="" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td class="menutop">
			<a href="member_profile.php?member_id=<?=$_GET['member_id']?>" target="_self">
		...
		<td class="menutop">
			<a href="member_profile.php?member_id=<?=$_GET['member_id'];?>&amp;inbox=1" target="_self">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>
							ข้อความขาเข้า / 收件箱
		...
		<td class="menutop">
			<a href="member_profile.php?member_id=<?=$_GET['member_id'];?>&amp;send=1" target="_self">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>
