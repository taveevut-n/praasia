                        ...
                        <tr>
                          <td>
                            <select name="catalog" id="catalog" style="width:300px;">
                              ...
                              ?>
                                <option value="<?= $dbcatalog->f(catalog_id) ?>" <?php
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select name="main_id" onchange="get_CategoryData(this.value,'<?php echo $lang_Rigion; ?>')" style="width: 445px;">
                              ...
                              ?>
                                <option value="<?= $rmain['main_id'] ?>" 
                                <?php if ($_GET['e_product_id']) {
                                  if ($rmain['main_id'] == $db5->f(main_id)) {
                                    echo "selected";
                                  }
                                } ?>>
                                <?= $rmain['main_name' . $lang_Rigion] ?>
                              </option>
                              <?php
                              }
                              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <select name="pra_category_id" style="width: 445px;" onchange="pra_categorytousually(this.value,'<?php echo $lang_Rigion; ?>');">
                              ...
                              ?>
                                  <option value="<?php echo $rcategory_e['catalog_id']; ?>" <?php if ($_GET['e_product_id']) {
                                                                                              if ($rcategory_e['catalog_id'] == $db5->f(main_id)) {
                                                                                                echo 'selected="selected"';
                                                                                              }
                                                                                            } ?>>
                                    <?php echo $rcategory_e['catalog_name' . $lang_Rigion]; ?>
                                  </option>
                              <?php
                                }
                              }
                          ...
                          <td>
                            ...
                            <div class="box-usually">
                              <ul>
                                ...
                                ?>
                                  <li>
                                    <input type="checkbox" name="usually[]" value="<?= $rcategory_e['catalog_id'] ?>" <?php echo $text_checked; ?>><?= $rcategory_e['catalog_name' . $lang_Rigion] ?>
                        ...
                        <tr>
                          ...
                          <td style="color:#FC0">
                            <select name="frame" id="frame">
                              ...
                              ?>
                                <option value="<?= $dbmix->f(catalog_id) ?>" <?php if ($_GET['e_product_id']) {
                                                                              if ($dbmix->f(catalog_id) == $db5->f(detailcn4)) {
                                                                                echo 'selected="selected"';
                                                                              }
                                                                            } ?>>
                        ...
                        <tr>
                          ...
                          <td style="color:#FC0">
                            <select name="condition" id="condition">
                              ...
                              ?>
                                <option value="<?= $dbmix->f(catalog_id) ?>" <?php if ($_GET['e_product_id']) {
                                                                              if ($dbmix->f(catalog_id) == $db5->f(detailcn7)) {
                                                                                echo 'selected="selected"';
                                                                              }
                                                                            } ?>>
                                  <?= $dbmix->f(catalog_name) ?>
                        ...
                        <tr>
                          ...
                          <td style="color:#FC0">
                            <select name="size" id="size">
                              ...
                              while ($dbmix->next_record()) {
                              ?>
                                <option value="<?= $dbmix->f(catalog_name_cn) ?>" <?php if ($_GET['e_product_id']) {
                                                                                  if ($dbmix->f(catalog_name) == $db5->f(detailcn8)) {
                                                                                    echo 'selected="selected"';
                                                                                  }
                                                                                } ?>>
                                  <?= $dbmix->f(catalog_name) ?>
                        ...
                        <tr>
                          ...
                          <td style="color:#FC0">
                            <select name="year" id="year">
                              ...
                              ?>
                                <option value="<?= $db_ps->f(catalog_id) ?>" <?php
                                                                            if ($_GET['e_product_id']) {
                          ...
                          <td style="color:#FC0;">
                            <table border="0" cellpadding="0" cellspacing="0">
                              ...
                              ?>
                                <tr>
                                  <td>
                                    <input name="useful[]" <?php if ($_GET["e_product_id"]) {
                                                              if (in_array($dbmix->f("catalog_id"), $detailcn12_array)) {
                                                                echo "checked='checked'";
                                                              }
                                                            } ?> id="useful_<?= $dbmix->f(catalog_id) ?>" value="<?= $dbmix->f(catalog_id) ?>" type="checkbox" />
                                  </td>
                                  <td style="color:#FC0;">
                  ...
                  <tr>
                    <td colspan="2" height="49" align="center" style="color:#FC0; white-space:nowrap;">
                      ...
                      <select name="status" id="status" style="width:300px;">
                        <option value="1" <?php if ($_GET['e_product_id']) {
                                            if ($db5->f(status) == 1) {
                                              echo 'selected="selected"';
                                            }
                                          } ?>>พระโชว์ / 展示</option>
                        <option value="2" <?php if ($_GET['e_product_id']) {
                                            if ($db5->f(status) == 2) {
                                              echo 'selected="selected"';
                                            }
                                          } ?>>ให้เช่า / 出售</option>
                        <option value="3" <?php if ($_GET['e_product_id']) {
                                            if ($db5->f(status) == 3) {
                                              echo 'selected="selected"';
                                            }
                                          } ?>>เปิดจอง / 预定</option>
                        <option value="4" <?php if ($_GET['e_product_id']) {
                                            if ($db5->f(status) == 4) {
                                              echo 'selected="selected"';
                                            }
                                          } ?>>จองแล้ว / 已定</option>
                        <option value="5" <?php if ($_GET['e_product_id']) {
                                            if ($db5->f(status) == 5) {
                                              echo 'selected="selected"';
                                            }
                                          } ?>>ขายแล้ว / 已出售</option>
                          ...
                          <td width="67%">
                            <select name="catalogpra" id="catalogpra" style="width:200px">
                              ...
                              ?>
                                ...
                                ?>
                                    <option value="<?= $db7->f(catalog_id) ?>" <?php if ($_GET['e_product_id']) {
                                                                                if ($db7->f(catalog_id) == $db->f(catalog_id)) {
                                                                                  echo 'selected="selected"';
                                                                                }
                                                                              } ?>>---
                                      <?= $db7->f(catalog_name) ?>
                        ...
                        <tr>
                          ...
                          <td style="color:#FC0;">
                            <select name="release" id="release">
                              ...
                              <option value="1" <?php if ($_GET['e_product_id']) {
                                                  if ("1" == $db5->f(prarelease)) {
                                                    echo 'selected="selected"';
                                                  }
                                                } ?>>พระเก่า / 老牌</option>
                              <option value="2" <?php if ($_GET['e_product_id']) {
                                                  if ("2" == $db5->f(prarelease)) {
                                                    echo 'selected="selected"';
                                                  }
                                                } ?>>พระใหม่ / 新牌</option>
                            </select>
