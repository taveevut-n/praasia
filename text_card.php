	    ...
	    <option value="0">
	      เลือกรุ่นพระเครื่อง / 选佛牌分类
                    ...
                    <td valign="top" style="padding-left:20px"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="500" valign="top" bgcolor="#311407"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td align="center"><span style="font-size:14px; font-weight:bold; color:#FC0">บัตรรับรองพระเครื่อง</span></td>
                          </tr>
                          <?php 
									$q="SELECT * FROM `certificate_txt` WHERE 1 ";
									$dbnews= new nDB();
									$dbnews->query($q);
									$dbnews->next_record();
								  ?>
