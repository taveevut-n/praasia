...
<html>
   <head>
      <title>ระบบจัดการเว็บไซต์ : แก้ไขรหัสผ่าน</title>
      ...
      <?php
         if($_POST['submit']){
         	if($_POST['h_member_id']){		
         		$q="UPDATE `member` SET `password` = '". md5(base64_encode(md5(md5($_POST['password']))))."' WHERE `id` ='".$_POST['h_member_id']."'  ";			
         		$db->query($q);	
         	redi2();		
         	}
         	}
            ...
            <td width="1000" height="180" style="background:url(images/backend.jpg) no-repeat">
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                     ...
                     <td><a href="shop_index.php?shop=<?=$_SESSION['shop_id']?>" target="_blank" onMouseOver="MM_swapImage('Image8','','images/images/menu-backend2_02.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="images/images/menubackend_02.jpg" name="Image8" width="130" height="180" border="0"></a></td>
            ...
            <td valign="top" style="padding:5px; background:url(images/backend-bgbanner.jpg) no-repeat">
               <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  <table width="100%" border="0" cellspacing="0" cellpadding="3">
                     <tr>
                        <td width="33%" height="44" align="right" valign="top" style="padding-right:15px; padding-top:23px; font-weight:bold">แก้ไขรหัสผ่าน / 增改密码 :</td>
                        <td width="67%" valign="bottom" style="padding-top:3px"><input name="password" type="text" id="password" value="" size="30"></td>
                     </tr>
                     <tr>
                        <td height="127" colspan="2" align="center" valign="bottom"><input name="submit" type="submit" id="submit" value="แก้ไขรหัสผ่าน / 增改密码" />
