...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2" class="box_from3_2">
			    ...
			    <tr>
                              ...
                              <td bgcolor="#3c1204"><textarea id="banner_detail" name="banner_detail"><?=($_GET['e_banner_id'])?$db5->f(banner_detail):"&nbsp;"?></textarea>
							<script type="text/javascript">
                                            var oEdit1 = new InnovaEditor("oEdit1");
                                            oEdit1.width = 650;
                                            oEdit1.height = 400;
										/*Enable Custom File Browser */
										oEdit1.fileBrowser = "/admin/innovaeditor/assetmanager/asset.php";											
                                            oEdit1.groups = [
                                            ...
                                            oEdit1.REPLACE("banner_detail");
                            </script>                       </td>
                      </tr>
			    <tr>
                              <td align="right" bgcolor="#3c1204" class="sidemenu"  style="padding-right:3px">Detail</td>
                              <td bgcolor="#3c1204"><textarea id="banner_detail2" name="banner_detail2"><?=($_GET['e_banner_id'])?$db5->f(banner_detail2):"&nbsp;"?></textarea>
							<script type="text/javascript">
                   ...
                   <table width="700" border="0" align="center" cellpadding="0" cellspacing="3" bordercolor="#FFFFFF">
                          ...
                          <tr bgcolor="<?=($v%2==0)?"#F8F8F8":"#FFFFFF"?>">
                            <td height="110" align="left" bgcolor="#3c1204" style="padding-left:10px" ><img src="../resize/w274-h100-c4:1/pra/img/banner/<?=$db->f(banner_img)?>" width="274" height="100" /></td>
