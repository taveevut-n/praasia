												...
												<tr>
													...
													<td height="500" valign="top" bgcolor="#311407">
														<table width="100%" border="0" cellspacing="0" cellpadding="10">
															...
															<?php 
																$q="SELECT * FROM `policy_referee` WHERE 1 ";
																$dbnews= new nDB();
																$dbnews->query($q);
																$dbnews->next_record();
																 ?>
															...
															<tr>
																<td align="center">
																	<input type="submit" id="agree" name="agree" value="ยืนยันการสมัครสมาชิก / 确定" disabled="disabled" onClick="window.location='register_referee.php'" style="cursor:pointer;"/>
