...
<div class="right_button" attr_opened="0">
	<table style="width:35px; height:200px;" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td>
				<table align="center" border="0" cellpadding="0" cellspacing="0" style="color:#FFF">
					<tr>
						<td>
							แ
						</td>
...
<?php } else { ?>
<a onclick="javascrip:alert('สำหรับสมาชิกเท่านั้น / 您还未注册-登录');return false" style="color:#FFF" >
<div class="right_button2" style="color:#FFF" >
	<table style="width:35px; height:200px;" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td>
				<table align="center" border="0" cellpadding="0" cellspacing="0" style="color:#FFF">
...
<table style="width:600px; height:350px; border-left:10px solid #fca909;" border="0" cellpadding="0" cellspacing="0">
	<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td style="padding-left:10px; width:1px; vertical-align:top;">
									<textarea class="textbox_translate" onkeyup="rightpanel_translate_text($(this));" style="padding:10px; width:250px; height:150px;"></textarea>
								</td>
								<td style="padding-left:10px; padding-right:10px; vertical-align:top;">
									<div class="translated_outer">
										<table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
											<tr>
												<td class="translated_container">
													&nbsp;
												</td>
											</tr>
										</table>
				...
				<tr>
					<td style="padding-top:7px; padding-bottom:7px; background-color:#ffffff;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td class="translateleave_info" colspan="2" style="padding-left:20px; padding-right:10px; padding-top:3px; font-size:12px; color:#ff0000;">
