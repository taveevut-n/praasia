            ...
            <tr>
              <td style="padding-top:7px">
                <table width="100%" border="0" align="center" cellpadding="10" cellspacing="0">
                  <tr>
                    <td style=" text-align:center; color:#FFF; font-size:14px;border: 1px #fff solid;">
                      <?= $dbproduct->f(detail) ?>
                    </td>
                  </tr>
                </table>
                    ...
                    <td align="left" bgcolor="#FFFFCC">
                      <table width="100%" border="0" align="left" cellpadding="3" cellspacing="0" style="font-weight:bold">
                        ...
                        <tr>
                          ...
                          <td class="detail-text"><? if ($dbshop->f(banktype1) == 1) {
                                                    echo ออมทรัพย์;
                                                  } else {
                                                    echo กระแสรายวัน;
                                                  } ?></td>
                      ...
                      function shoppm_signin() {
                        ...
                        if (username != "" && password != "") {
                          ...
                          $.ajax({
                            ...
                            url: "shop_query.php",
                            data: {
                              do_what: "shoppm_signin",
                              username: username,
                              password: password,
                              member: "<?= $_SESSION['shop_id'] ?>"
                            },
                            cache: false,
                      ...
                      function shoppm_translate_leave() {
                        ...
                        if ($.trim(v) != "") {
                          $.ajax({
                            ...
                            url: "shop_query.php",
                            data: {
                              do_what: "shoppm_translate_leave",
                              v: v
                            },
                            cache: false,
                            success: function(result) {
