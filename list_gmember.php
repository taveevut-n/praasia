								...
								<td style="padding-left:5px;padding-right:5px">
									...
									<tr>
										<td>
											<?php
												$dbshop= new nDB();
												$q="SELECT * FROM `member` WHERE active = '2' AND type= '2' ";
												$p_r=1;
												$dbshop->query($q);                           
											...
											<table width="145" border="0" align="center" cellpadding="0" cellspacing="0" style="float:left; margin:5px; width:145px;">
												...
												<td align="center">
													<table width="90%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td bgcolor="#000000">
															<a href="member_profile.php?member_id=<?=$dbshop->f(id)?>">
																<img src="<?=($dbshop->f(img_profile)!="")?'img_profile/_thumbnail/'.$dbshop->f(img_profile):"images/logodefault_general.jpg"?>" alt="" width="153" height="150" border="0" />
																</a>
															</td>
														</tr>
													</table>
												...
												<td valign="top" bgcolor="#666666">
													<table width="100%" border="0" cellspacing="0" cellpadding="3">
														<tr>
															<td height="20">
															<a href="member_profile.php?member_id=<?=$db->f(product_id)?>">
																<div  style="width:142px; overflow:hidden; white-space:nowrap;text-align: center;" >
																	<span style="color:#FFF"><?=$dbshop->f(name)?></span>
																</div>
															</a>
															</td>
														</tr>
												...
												<tr>
													<td height="25" align="center" bgcolor="#333333">
														<span style="color:#FFF">ผู้เข้าชม : <?=$dbshop->f(view_num)?> คน</span>
													</td>
												</tr>
											</table>
											<?php } ?> 
