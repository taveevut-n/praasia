																		...
																		<tr>
																			<td style="padding-left:5px;padding-right:5px;background:#000;padding-bottom: 100px;">
																				...
																				<table width="100%" cellpadding="3" cellspacing="0">
																					...
																					<tr>
																						<td>
																							<a><h3 style="color: #E5CB15;"><?php echo $main['main_name'];?> / <?php echo $main['main_name_cn'];?></h3></a>
																							<?php
																							...
																							while ( $category = mysql_fetch_array($qcat)) {
																								...
																								<table cellpadding="3" cellspacing="0" class="table-catdisplay">
																									<tr>
																										...
																										<td>
																											<a class="text-linkmain" href="product_group.php?c=<?php echo $category['catalog_id'];?>&g=<?php echo $main['main_id'];?>">
